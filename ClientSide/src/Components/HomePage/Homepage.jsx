...
const Homepage = () => {
  ...
  return (
    <>
      <div className=" scrollbar-hide w-[100vw]  h-[100vh]  bg-black overflow-x-hidden">
        <div
          className=" h-[300vh] w-[100vw] overflow-x-hidden bg-black  "
          ref={p1}
        >
          <div className=" h-[100vh] overflow-x-hidden  scrollbar-hide relative">
            ...
            <div className=" flex w-full h-full z-20 relative items-center justify-center flex-col gap-10">
              <div
                ...
                id="txt"
              >
                "KNOWLEDGE IS LIKE A GARDEN, IF IT IS NOT CULTIVATED, IT CANNOT
                BE HARVESTED."
              </div>
